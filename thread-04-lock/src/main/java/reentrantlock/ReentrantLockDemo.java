...
public class ReentrantLockDemo {
    ...
    static class MyThread extends Thread {
        ...
        private MyThread(String name, Task task) {
            super(name);
            this.task = task;
        }
    ...
    static class Task {
        ...
        public void executeTryLockTime() {
            try {
        ...
        public void executeLockInterruptibly() {
            try {
